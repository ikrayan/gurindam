 ...
 <!-- Lets Share -->
  	<div class="card mb-4">
     	...
     	<div class="card-body px-3 shadow">
			...
			if(isset($_SESSION['member_status'])){ //Jika login
				$datashare = mysqli_query($koneksi, "select * from posting where posting_kategori='0' and posting_step=2 order by posting_id DESC LIMIT 8");	
				
			}else{ //Jika tidak login
				$datashare = mysqli_query($koneksi, "select * from posting where posting_kategori='0' and posting_visibility='publik' and posting_step=2 order by posting_id DESC LIMIT 8");
			}			
			//end logic sql
			...
			?>				
				<div class="d-flex align-items-center col-lg-6 mb-4">
					...
					<div class="justify-content-start">
						<a href="diskusi.php?id_posting=<?php echo $listshare['posting_id']; ?>"><span class="text-black-50"><?php echo strtoupper($listshare['posting_judul']); ?></span></a>
