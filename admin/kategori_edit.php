            ...
            <form action="kategori_update.php" method="post">
              ...
              while($d = mysqli_fetch_array($data)){
                ...
                <div class="form-group">
                  ...
                  <?php
                  	$dataj = mysqli_query($koneksi, "select kategori_jenis from kategori");
				  	?>
             		<option value="<?php echo $d['kategori_jenis'] ?>"><?php echo $d['kategori_jenis'] ?></option>
             		<?php
              		while($dj = mysqli_fetch_array($dataj)){
                  	?>
                  		<option value="<?php echo $dj['kategori_jenis'] ?>"><?php echo $dj['kategori_jenis'] ?></option>
                  <?php 
					} 
					?>
                  </select>
