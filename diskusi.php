      	...
      	if(!empty($d['posting_tags'])){
			...
			for($t=0; $t < count($tags); $t++){
				echo "<a href='indexQ.php?cariTags=".$tags[$t]."&kategori=all' target='_blank'>
						<span class='badge text-black-50 my-1 ml-n1'><i class='fa fa-tag'></i> ".$tags[$t]."</span>
					 </a>";
			}
		}
		?>     		
      	<!-- Akhir Tags-->
       	...
       	<h4 class="mb-3" style="line-height: 1.25"><?php echo strtoupper($d['posting_judul']); ?></h4>
...
<!-- akhir judul posting -->  
		...
		<hr class="mt-3 mb-0">
         ...
         <!-- isi posting -->
         <div class="card-body shadow-lg overflow-hidden py-1">
...
<!-- iframe -->
		<!--<iframe src="https://pekanbaru.bkn.go.id/kms/attachment/<?php// echo $i['attach_name']; ?>" width="100%" height="600px"></iframe>-->
<!-- iframe -->
...
<!-- foto author --> 
         ...
         <div class="clearfix">
		  	...
		  	<a href="detail_member.php?id=<?php echo $d['PNS_ID']; ?>">
					  ...
					  if($d['PNS_FOTO'] == ""){
						?>
						<img class="img-fluid mr-2" style="width: 50px;height: 50px" src="gambar/sistem/member.png">
						<?php
					  }else{
						?>
						<img class="img-fluid mr-2" style="width: 50px;height: 50px" src="gambar/member/<?php echo $d['PNS_FOTO'] ?>">
						<?php
					  }
					  ?>
 ...
 <!-- akhir foto author -->
       ...
       <!--<div class="clearfix mb-n4 shadow-lg bg-light">
		   <center>
				<a href="detail_member.php?id=<?php //echo $d['PNS_ID']; ?>">
					<b><small class="ml-2 text-dark"><b><?php //echo $d['NAMA'] ?></b>&nbsp;-&nbsp;<?php //echo $d['JABATAN_NAMA']; ?></small></b>
				</a>
		   </center>
	   </div>
