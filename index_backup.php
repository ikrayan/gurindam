      ...
      <div class="card">
        ...
        -->
			...
			if (isset($_GET['urutan'])){
			   ...
			   if (empty($bagianWhere)){
				   if($urutan=="terbaru"){
						$bagianWhere .= "order by posting_id DESC LIMIT $mulai, $halaman";
			   		}elseif($urutan=="terlama"){
					    $bagianWhere .= "order by posting_id ASC LIMIT $mulai, $halaman";
				   }else{
				    	$bagianWhere .= "order by posting_dibaca DESC LIMIT $mulai, $halaman";
			   		}
				}else{
				   if($urutan=="terbaru"){
						$bagianWhere .= " order by posting_id DESC LIMIT $mulai, $halaman";
