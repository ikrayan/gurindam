...
<?php
	...
	function ikon($ext){
		switch ($ext) {
			...
			case "mp4": case "flv": case "mpg": case "mpeg": case "mkv": case "mov": case "avi": case "wmv": case "avchd": case "webM": case "m4v":
				echo "file-video";
				break;					
       	...
       	<div class="row">
			<div class="d-flex align-content-center">
				...
				<img src="gambar/sistem/logo.png" height="32px" class="ml-4 mb-0 mr-2">
					<b>GURINDAM </b><!-- |<span style="color: orange">KANREGXII</span><b>BKN</b>
					<small> KANREG XII BKN</small></a> --> 
			</div>
        </div>
